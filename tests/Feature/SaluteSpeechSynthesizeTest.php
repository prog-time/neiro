...
class SaluteSpeechSynthesizeTest extends AiTestCase
{
    protected string $typeAi = "SaluteSpeech";

    protected string $basicUrl = "/api/compilations/speech_synthesize";
     ...
     * @return void
     */
    public function test_speech_synthesize(): void
    {
        $nameTestFile = "text_synthesize.txt";
     ...
     * @return void
     */
    public function test_get_speech_synthesize_404(): void
    {
     ...
     * @return void
     */
    public function test_get_speech_synthesize_202(): void
    {
     ...
     * @return void
     */
    public function test_get_speech_synthesize_200(): void
    {
