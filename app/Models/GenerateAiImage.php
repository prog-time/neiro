...
class GenerateAiImage extends Model
{
    use HasFactory;
     ...
     */
    public static function getGenerateByIdAndService(int $idElem, string $nameService): ?GenerateAiImage
    {
        return static::where([
            'id' => $idElem,
     ...
     * @return GenerateAiImage|null
     */
    public static function getGenerateById(int $idElem): ?GenerateAiImage
    {
     ...
     * @return GenerateAiImage|null
     */
    public static function updateGenerateById(int $idElem, array $updateData): ?GenerateAiImage
    {
     ...
     * @return GenerateAiImage|null
     */
    public static function getGenerateByDataQuery(string $dataQuery): ?GenerateAiImage
    {
